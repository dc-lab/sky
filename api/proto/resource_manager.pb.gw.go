...
var (
	filter_ResourceManager_GetResources_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_ResourceManager_GetResources_0(ctx context.Context, marshaler runtime.Marshaler, client ResourceManagerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_ResourceManager_GetResources_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_ResourceManager_GetResources_0(ctx context.Context, marshaler runtime.Marshaler, server ResourceManagerServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetResourcesRequest
	var metadata runtime.ServerMetadata
...
func RegisterResourceManagerHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ResourceManagerServer) error {
	...
	mux.Handle("GET", pattern_ResourceManager_GetResources_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ResourceManager_GetResources_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_ResourceManager_GetResources_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterResourceManagerHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ResourceManagerClient) error {
	...
	mux.Handle("GET", pattern_ResourceManager_GetResources_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ResourceManager_GetResources_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_ResourceManager_GetResources_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "resources"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_ResourceManager_GetResources_0 = runtime.ForwardResponseMessage
)
